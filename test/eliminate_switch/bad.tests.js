const Notifier = require('../../src/eliminate_switch/bad');
const expect = require('chai').expect;
const sinon = require('sinon');

describe('eliminate-switch - bad: Notifier', function () {
    ...
    it('should throw error when invalid channelType', function (done) {
        const notifier = new Notifier(scheduler);
        expect(() => notifier.publishNotification(message, "Invalid")).to.throw(Error, "No Notification Type found: Invalid");
        done();
    });
});